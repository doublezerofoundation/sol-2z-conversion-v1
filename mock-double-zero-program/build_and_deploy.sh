...
show_help() {
  ...
  echo ""
  echo "Build and deploy script for Mock Double Zero Program"
  echo ""
  echo "OPTIONS:"
...
echo "================================================================================================"
echo "         					BUILD_AND_DEPLOY (MOCK DOUBLE ZERO PROGRAM) "
echo "================================================================================================"
...
case "$mode" in
  ...
  build_only)
    build_program
    log_info "Successfully built the Mock Double Zero program"
    ;;
  build_and_deploy)
    build_program
    deploy_program
    log_info "Successfully built and deployed the Mock Double Zero program into the network!"
    ;;
  *)
